...
?>
    ...
    $stringVar = "Рядок"; // Рядкова змінна
    $intVar = 666; // Ціле число
    $floatVar = 666.66; // Число з плаваючою комою
    $boolVar = false; // Булеве значення
